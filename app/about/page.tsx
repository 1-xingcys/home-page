...
import { Container, Section, H1, P, Timeline, GradientText } from '@/components/ui'
...
export default function About() {
  ...
  const timeLineItems = [
    ...
    },
    {
      time: '2021/09',
      title: '台大資管系入學',
      description: '選擇涉略範圍廣的資管系，開始探索程式領域',
      detail: (
        <div className="space-y-4">
          <p>
    ...
    },
    {
      time: '2022/09 - now',
      title: '雙主修台大經濟',
      description: '透過經濟學學習，決定雙主修提升學習廣度',
      detail: (
        <div className="space-y-4">
          <p>
    ...
    },
    {
      time: '2023/09 - now',
      title: '轉系台大資工',
      description: '確認喜歡資訊領域，決心轉入資工系深造',
      detail: (
        <div className="space-y-4">
          <p>
